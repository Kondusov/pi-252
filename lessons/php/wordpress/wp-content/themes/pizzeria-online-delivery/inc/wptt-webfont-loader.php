...
if ( ! class_exists( 'Pizzeria_Online_Delivery_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Pizzeria_Online_Delivery_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$pizzeria_online_delivery_contents = wp_remote_retrieve_body( $response );

			return $pizzeria_online_delivery_contents;
		}
...
if ( ! function_exists( 'pizzeria_online_delivery_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function pizzeria_online_delivery_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Pizzeria_Online_Delivery_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'pizzeria_online_delivery_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function pizzeria_online_delivery_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Pizzeria_Online_Delivery_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
